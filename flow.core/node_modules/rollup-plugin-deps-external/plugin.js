...
export function depsExternal({ builtins = true, dependencies = true, packagePath, peerDependencies = true, } = {}) {
    return {
        name: 'deps-external',
        options(opts) {
            let pkg;
            ...
            const newExternal = (source, importer, isResolved) => {
                ...
                */
                try {
                    ...
                    return packageIds.some((id) => resolvedDirname.startsWith(path.dirname(id)));
                }
                catch {
                    return false;
                }
