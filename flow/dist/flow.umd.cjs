(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.flow = {}));
...
`;
  ...
  function onFinishedPriorityLevel(level, didActualWork) {
    if (exports2.trace) log$4("<<<finished priority: " + level + ">>>");
  ...
  class Component {
    ...
    onEstablish() {
      ...
      if (exports2.trace) log$4("Established:" + this.toString());
    }
    startGeneralEnsure() {
    ...
    onDispose() {
      ...
      if (exports2.trace) log$4("Disposed:" + this.toString());
  ...
  class DOMNode extends FlowPrimitive {
    dimensions(contextNode) {
      if (exports2.traceWarnings) console.warn("Calls to dimensions() could lead to performance issues as it forces a reflow to measure the size of a dom-node. Note that transition animations may use dimensions() for measuring the size of added nodes");
    ...
    ensureDomNodeExists() {
      if (this.givenDomNode) {
        ...
        this.createElementRepeater = repeat(mostAbstractFlow(this).toString() + ".createElementRepeater", (repeater) => {
          if (exports2.trace) log$3(repeater.causalityString());
          ...
          if (exports2.trace) log$3(this.domNode);
        }, { priority: 2 });
      }
      return this.domNode;
    }
  ...
  function freezeFlowChanges() {
    count++;
    if (exports2.traceAnimation && exports2.traceWarnings) console.warn("Risky to use freeze " + count);
  }
  function unfreezeFlowChanges() {
    count--;
    if (exports2.traceAnimation && exports2.traceWarnings) console.warn("Unfreeze... " + count);
  }
  let domFlowTargets = [];
  ...
  function onFinishReBuildingFlow() {
    ...
    if (exports2.traceAnimation) console.groupCollapsed("...");
  ...
  function onFinishReBuildingDOM() {
    ...
    if (exports2.traceAnimation) console.groupEnd();
  ...
  exports2.invalidateOnChange = invalidateOnChange$1;
  exports2.isObservable = isObservable;
  exports2.isUpperCase = isUpperCase;
  exports2.log = log$1$1;
  ...
  exports2.workOnPriorityLevel = workOnPriorityLevel$1;
