...
const target = new Engine2DRenderTarget(); // This would be a connection to the actual 2D rendering engine

target.setContent(fence);  // Starts reactive process of rebuilding fence upon change, and

// If the Mesh2D and Engine2DRenderTarget is implemented correctly, only minimal changes would be pushed to the rendering.  
